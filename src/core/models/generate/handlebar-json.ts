...
import FormatUtils  from '@/formatting'
...
export class HandlebarsColumn {
   ...
   */
    ...
    get javaTypeShortName(): string  {
        return this.typeName ? DbUtils.convertShortJavaType(this.typeName,this.columnSize) : '';
    }
    ...
    */
    get javaTypeName(): string {
        ...
        return this.typeName ? DbUtils.convertJavaType(this.typeName,this.columnSize) : '';
    }

    get jdbcTypeName(): string {
        return this.typeName? DbUtils.SqlType2JdbcType(this.typeName): '';
    }
}